...
def predict(train_cell_line, test_cell_line):
  ...
  '''data_path = '/home/panwei/' + test_cell_line + '/' + test_cell_line + '_ep_split.h5'
  ...
  predictions_path = '/home/panwei/zhuan143/all_cell_lines/'
  #for cell_line in cell_lines:
  print('Loading ' + test_cell_line + ' data from ' + data_path)
  X_enhancer = np.load(data_path + test_cell_line + '_enhancers.npy')
  X_promoter = np.load(data_path + test_cell_line + '_promoters.npy')
  y = np.load(data_path + test_cell_line + '_labels.npy')
  ...
  model.load_weights('/home/panwei/zhuan143/all_cell_lines/weights_' + train_cell_line + '.h5')
